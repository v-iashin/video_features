...
from torchvision.transforms import (CenterCrop, Compose, Normalize, Resize,
                                    ToTensor)
from video_features.utils.utils import KINETICS_CLASS_PATH, show_predictions_on_dataset, get_package_file_path
...
class ExtractCLIP(BaseFrameWiseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        if self.model_name in clip.available_models():
            ...
            model_path = Path(get_package_file_path('models/clip/checkpoints/CLIP-custom.pth'))
