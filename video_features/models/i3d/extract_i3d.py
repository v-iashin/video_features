...
from video_features.utils.utils import dp_state_to_normal, show_predictions_on_dataset, get_package_file_path
...
class ExtractI3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        i3d_weights_paths = {
            'rgb': str(get_package_file_path('models/i3d/checkpoints/i3d_rgb.pt')),
            'flow': str(get_package_file_path('models/i3d/checkpoints/i3d_flow.pt')),
        }
        name2module = {}
