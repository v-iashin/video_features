...
from video_features.models.raft.raft_src.update import (
    BasicUpdateBlock,
    SmallUpdateBlock,
)
...
from video_features.models.raft.raft_src.utils.utils import (
    bilinear_sampler,
    coords_grid,
    upflow8,
)
    ...
    def __init__(self):
        ...
        if self.model_is_small:
            ...
            self.cnet = SmallEncoder(
                output_dim=self.cnet_out_dim, norm_fn="none", dropout=self.dropout
            )
            ...
            self.cnet = BasicEncoder(
                output_dim=self.cnet_out_dim, norm_fn="batch", dropout=self.dropout
            )
