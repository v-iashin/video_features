...
from video_features.models.s3d.s3d_src.s3d import S3D
from video_features.models.transforms import CenterCrop, Resize, ToFloatTensorInZeroOne
from torchvision.io.video import read_video
from video_features.utils.io import reencode_video_with_diff_fps
from video_features.utils.utils import form_slices, show_predictions_on_dataset, get_package_file_path
...
class ExtractS3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        """
        s3d_kinetics400_weights_torch_path = str(get_package_file_path('models/s3d/checkpoint/S3D_kinetics400_torchified.pt'))
